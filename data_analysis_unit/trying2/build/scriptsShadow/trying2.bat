...
set CLASSPATH=%APP_HOME%\lib\trying2-0.1-SNAPSHOT-all.jar

@rem Execute trying2
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TRYING2_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TRYING2_EXIT_CONSOLE%" exit 1
exit /b 1
